...
public class GameController : MonoBehaviour {
    ...
    void player1control()
    {
		...
		if (Input.GetButton("Attack")|| Input.GetKeyUp("q"))
        {

            controller1.GetComponent<Control>().Attack();

        }
		if (Input.GetButton("Guard")|| Input.GetKeyUp("w"))
        {
            controller1.GetComponent<Control>().Guard();

        }
		if (Input.GetButton("Magic") || Input.GetKeyUp("e"))
        {
            controller1.GetComponent<Control>().MagicAtk();

        }
		if (Input.GetButton("Special") || Input.GetKeyUp("r"))
        {
    ...
    void player2control()
    {
		...
		if (Input.GetButton("Attack2") || Input.GetKeyUp("a"))
        {

            controller2.GetComponent<Control>().Attack();

        }
		if (Input.GetButton("Guard2") || Input.GetKeyUp("s"))
        {
            controller2.GetComponent<Control>().Guard();

        }
		if (Input.GetButton("Magic2") || Input.GetKeyUp("d"))
        {
            controller2.GetComponent<Control>().MagicAtk();

        }
		if (Input.GetButton("Special2") || Input.GetKeyUp("f"))
        {
